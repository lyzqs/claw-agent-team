...
install_bundle_files() {
  ...
  install -m 0644 "${REPO_ROOT}/deploy/grafana/dashboards/local-host-observability.json" /var/lib/grafana/dashboards/agent-team-grafana/local-host-observability.json
